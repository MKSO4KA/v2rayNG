...
object MmkvManager {
    ...
    private const val KEY_MIMICRY_PRESETS = "MIMICRY_PRESETS"
    ...
    fun decodeMimicryPresets(): MutableList<MimicryPreset> {
        val json = mainStorage.decodeString(KEY_MIMICRY_PRESETS)
